...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the canada ecoin database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with Bitcore Node CDN configuration')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-cdn create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-cdn add wallet-service');
      console.log('    $ bitcore-node-cdn add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-cdn remove wallet-service');
      console.log('    $ bitcore-node-cdn remove insight-api');
      console.log();
    });
